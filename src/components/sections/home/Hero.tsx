...
export default function Hero() {
  ...
  const handlePrimaryAction = () => {
    router.push('/'); // Navigate to portfolio showcase
  };

  const handleSecondaryAction = () => {
    setIsModalOpen(true); // Open project consultation modal
  };
  // ACTION_PLACEHOLDER_END

  return (
    <section className="relative overflow-hidden bg-background">
      {/* Natural gradient and organic pattern */}
        ...
        <div className="grid items-center gap-12 py-20 sm:py-24 lg:grid-cols-2 lg:gap-20 lg:py-32">
          ...
          <div className="flex flex-col justify-center">
            ...
            <p className="mt-6 max-w-xl text-lg leading-relaxed text-muted-foreground">
              Professional landscaping services that nurture your property while protecting the
              environment. From organic lawn care to native garden design.
            </p>
          ...
          <div className="relative">
            ...
            <div className="relative overflow-hidden rounded-2xl border bg-card shadow-2xl">
              <div className="aspect-[16/10] relative">
                <Image
                  src="https://images.unsplash.com/photo-1416879595882-3373a0480b5b?q=80&w=1920&auto=format&fit=crop"
                  alt="Beautiful sustainable garden landscape with native plants and eco-friendly design"
                  fill
            ...
            <div className="absolute -right-6 -top-6 hidden w-36 rounded-xl border bg-background/90 p-3 shadow-xl sm:block">
              ...
              <p className="text-sm">
                <span className="font-semibold">40%</span> reduction
              </p>
            </div>
